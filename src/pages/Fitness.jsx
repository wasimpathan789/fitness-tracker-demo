        ...
        <div className="container">
            <div className="fitnessWrapper">
                ...
                <div className="tracker">
                    <div className="trackerText"><h1>your <br /> fitness trakcer </h1></div>
                ...
                <div className="watchContainer">
                    ...
                    <div className="black">
                        ...
                        <div className="blackContainerCenter">
                            <p>Scan the device <br /> QR to connect</p>
                    ...
                    <div className="dropdown">
                        ...
                        {isOpen ? (
                            <div className="dropdownItems">
                                <li value={select} onChange={(e) => setSelect(e.target.value)} className="dropdownItems">Yes</li>
                                <li value={select} onChange={(e) => setSelect(e.target.value)} className="dropdownItems">No</li>
                            </div>
